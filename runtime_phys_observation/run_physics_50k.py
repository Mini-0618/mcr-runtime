...
PERSIST_DIR = '/home/minimak/mcr/runtime_phys_observation/run_data_50k'
...
for tick in range(1, TICKS + 1):
    ...
    for _ in range(random.randint(1, 3)):
        topic = random.choice(TOPICS)
        result = lm.retrieve(topic, top_k=5)
...
print(f"\n{'='*60}")
print(f"50K TICK LONG-RUN — FINAL REPORT")
print(f"{'='*60}")
print(f"  Ticks:        {TICKS:,}")
...
path = os.path.join(PERSIST_DIR, "runtime_physics_50k_data.json")
